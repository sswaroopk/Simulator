...
//Equations for Specification
  ...
  model test1
    Distillation distillation1(specification1 = DistillationPackage.Distillation.spec1.RefluxRatio, specification1_value = 2, specification2 = DistillationPackage.Distillation.spec2.ProductMolarFlow, specification2_value = 61.1) annotation(Placement(visible = true, transformation(origin = {-3, -7}, extent = {{-19, -19}, {19, 19}}, rotation = 0)));
    MaterialStream materialStream1(Flowrate = 95.7, Pressure = 1e5, Temperature = 360, molefraction = {0.45, 0, 0.55, 0}, stepchange = false, unspecified = false) annotation(Placement(visible = true, transformation(origin = {-70, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
